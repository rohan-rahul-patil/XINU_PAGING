...
*/
	...
	*( (int *)pptr->pbase ) = MAGIC;
	...
	frm_tab[4].fr_status = FRM_MAPPED;
        ...
        frm_tab[4].fr_vpno = frame;
        frm_tab[4].fr_refcnt = 0;
...
/*------------------------------------------------------------------------
 * sizmem - r	eturn memory size (in pages)
 *------------------------------------------------------------------------
 */
long sizmem()
{
